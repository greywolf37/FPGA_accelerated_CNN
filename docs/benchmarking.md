...
We have provided a benchmarking template below to standardize the benchmarking process. As usage of your FPGA-accelerated network differs from person to person, there are sections you must fill out yourself. See [lab 1](../../lab1/docs/lab1_intro.md) for a refresher on how to use PyTorch.
